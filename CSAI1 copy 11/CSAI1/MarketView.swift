...
//  CRYPTOSAI
//
//  A large Market screen (~400+ lines) preserving your existing:
...
class MarketViewModel: ObservableObject {
    ...
    // If you still want sample data, you can keep or remove this function
    private func loadSampleCoins() {
        // Sample data commented out since we won't fallback
        // coins = [ ... ]
    }
    ...
    func fetchRealCoinsFromCoinGecko() {
        ...
        let urlString = "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=20&sparkline=false"
        ...
        URLSession.shared.dataTask(with: url) { data, response, error in
            defer {
                // We'll remove the spinner whether success or fail
            ...
            let newCoins: [MarketCoin] = decoded.map { item in
                MarketCoin(
                    ...
                    isFavorite: false,
                    sparklineData: [] // sparkline=false => no sparkline
                )
            }
            ...
            ZStack {
                ...
                if vm.isLoading {
                    ...
                    VStack(spacing: 0) {
                        ...
                        .refreshable {
                            // If you want a pull-to-refresh that calls the API again:
