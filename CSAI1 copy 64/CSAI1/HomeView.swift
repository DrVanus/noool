...
struct HomeView: View {
    ...
    @State private var selectedHeatMapTimeframe: HeatMapTimeframe = .oneDay
            ...
            NavigationView {
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(alignment: .leading, spacing: 16) {
                        // Portfolio summary / chart with notifications & settings buttons at top right
                        ...
                        // Updated Market Sentiment section with natural sizing
                        MarketSentimentView()
...
extension HomeView {
    ...
    private var heatMapSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            sectionHeading("Market Heat Map", iconName: "square.grid.2x2")
            
            
            // Heat map grid
            HeatMapCard(timeframe: selectedHeatMapTimeframe)
                .padding(.bottom, 16)
        }
        .padding(.vertical, 12)
        .padding(.horizontal, 16)
