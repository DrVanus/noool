...
struct TradingBotView: View {
    ...
    var body: some View {
        VStack(spacing: 16) {
            ...
            HStack {
                Text("Qty:")
                Spacer()
                Text("\(quantity, specifier: "%.4f")")
            }
 
            HStack {
                Text("Slippage:")
                Spacer()
                Text("\(Int(slippage * 100))%")
            }
            ...
            Button(action: {
                ...
                Text(isRunning ? "Stop Bot" : "Start Bot")
                    ...
                    .padding()
                    .background(isRunning ? Color.red : Color.yellow)
    ...
    private func startBot() {
        ...
        // TODO: kick off your bot logic here
    }
 
    private func stopBot() {
        statusMessage = "Stopped"
        // TODO: tear down your bot here
    }
}
...
extension TradingBotView {
    private var customNavBar: some View {
        VStack(spacing: 0) {
            ...
            HStack {
                Button {
                    // Dismiss logic; if this view is pushed, this may pop it.
                    // Adjust if needed.
                    // (Alternatively, remove this back button if your NavigationView already provides one.)
                    // For demonstration, we include it:
                    dismissView()
                } label: {
                ...
                // (Manage button moved to the toolbar above)
            }
            .padding(.horizontal)
            .padding(.top, 12)
