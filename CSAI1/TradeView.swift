...
struct TradeView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            // 5) Chart-Type Toggle (below intervals)
            chartTypeToggle
    ...
    // MARK: - Chart Type Toggle (Below intervals)
        ...
        VStack(spacing: 12) {
            ...
            HStack(spacing: 0) {
                ...
                Button {
                    ...
                    Text("Sell")
                        .font(.system(size: 14, weight: .semibold))
                        .foregroundColor(selectedSide == .sell ? .white : .white)
                        .padding(.vertical, 10)
                        .frame(maxWidth: .infinity)
...
struct TradeCustomChart: View {
    ...
    private var chartContent: some View {
        ...
        Chart {
            ...
            // If you have candlestick logic, place it here.
