...
struct PortfolioView: View {
    ...
    // Use the unified ChartTimeRange (defined in ChartTimeRange.swift)
    // For the portfolio page, we default to "year" (1Y)
    @State private var selectedRange: ChartTimeRange = .year
    
    // For searching holdings
    @State private var searchTerm: String = ""
    
    // Sheets for adding holdings and settings
    ...
    // Placeholder transactions array (if needed)
